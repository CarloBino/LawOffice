<x-app-layout>
    ...
    <div class="bg-[#eef0ec] py-8">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            @php
                $filterCount = collect(['payment_status', 'client_id', 'case_id', 'balance'])
                            ...
                            @forelse($billings as $b)
                                <tr class="transition hover:bg-[#f8f8f6]">
                                    ...
                                    <td class="px-5 py-4 text-right">
                                        <a href="{{ route('billings.show', $b->id) }}" class="text-sm font-bold text-[#9f7957] hover:text-[#030203]">Manage</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
